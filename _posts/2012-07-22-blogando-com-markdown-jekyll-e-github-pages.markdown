...
Me sinto muito mais confortável dessa forma, com um editor de texto (recomento o <a href="http://www.sublimetext.com/" alt="Sublime Text" target="_blank">Sublime Text</a>) e alguns comandos via Git Bash tudo está no meu repositório.
